      ...
      >
        <Button
          ...
          style={{
            ...
            marginRight: "10px",
            background:
              selectedReport === "Revenue Report" ? "#665651" : "#D0C8B6",
            color: selectedReport === "Revenue Report" ? "white" : "#665651",
          }}
        ...
        <Button
          ...
          style={{
            ...
            marginRight: "10px",
            background:
              selectedReport === "Guest Trend Report" ? "#665651" : "#D0C8B6",
            color:
              selectedReport === "Guest Trend Report" ? "white" : "#665651",
          }}
        ...
        <Button
          ...
          style={{
            flex: 1,
            background:
              selectedReport === "Occupancy Analysis" ? "#665651" : "#D0C8B6",
            color:
              selectedReport === "Occupancy Analysis" ? "white" : "#665651",
          }}
      ...
      {selectedReport === "Guest Trend Report" && (
        ...
        >
          <Table striped bordered hover>
            ...
            <tbody>{/* Render guest trend report data here */}</tbody>
          </Table>
        </Card>
      )}
      ...
      {selectedReport === "Occupancy Analysis" && (
        ...
        >
          <Table striped bordered hover>
            ...
            <tbody>{/* Render occupancy analysis data here */}</tbody>
          </Table>
        </Card>
      )}
    </div>
